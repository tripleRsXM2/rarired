var THEMES = {
  wimbledon: {
    bg:"#F2EEE8", bgCard:"#FFFFFF", bgTertiary:"#EBE6DD", surfaceSolid:"#FFFFFF",
    border:"#DDD5C7", borderStrong:"#C5BDA8",
    text:"#1A1A1A", textSecondary:"#5C5C5C", textTertiary:"#A0A0A0",
    accent:"#2F3E38", accentText:"#FFFFFF", accentSubtle:"rgba(47,62,56,0.08)",
    green:"#4A6A4D", greenSubtle:"rgba(74,106,77,0.08)",
    red:"#B33A3A", redSubtle:"rgba(179,58,58,0.08)",
    orange:"#D18032", orangeSubtle:"rgba(209,128,50,0.08)",
    gold:"#A8BC45", goldSubtle:"rgba(168,188,69,0.10)",
    purple:"#5C3A6E", purpleSubtle:"rgba(92,58,110,0.08)",
    inputBg:"#F2EEE8", modalBg:"#FFFFFF",
    navBg:"rgba(242,238,232,0.92)", tabBar:"rgba(242,238,232,0.95)",
    qualified:"rgba(74,106,77,0.06)",
    r:6, r2:10,
  },
  ao: {
